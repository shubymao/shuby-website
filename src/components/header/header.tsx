  ...
  return (
    <header style={blurStyle} className="fixed w-full bg-black bg-opacity-70 items-center shadow-xl">
      <div className="container max-w-5xl flex justify-between mx-auto">
        <a href="#" className={'flex flex-row items-center mx-auto md:mx-3 px-2 space-x-2 ' + HOVER_STLYE}>
          <Icon height="40px" />
          <p className="hidden sm:block text-lg whitespace-nowrap text-white font-bold">{HEADER_TITLE}</p>
        </a>
